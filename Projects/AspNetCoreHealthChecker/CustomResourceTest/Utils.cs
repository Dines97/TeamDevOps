...
public class Utils
{
  ...
  public static CustomResourceDefinition MakeCRD()
  {
    ...
    {
      Kind = "CResource", Group = "csharp.com", Version = "v1alpha1", PluralName = "customresources",
    };
  ...
  public static CResource MakeCResource()
  {
    var myCResource = new CResource()
    {
      ...
      Metadata = new V1ObjectMeta
      {
        ...
        Labels = new Dictionary<string, string> { { "identifier", "city" }, },
      },
      // spec
      Spec = new CResourceSpec { CityName = "London", },
    };
    return myCResource;
  }
}
